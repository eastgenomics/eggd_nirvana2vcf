...
main() {
    ...
    echo "Value of json_file_prefix: '$json_file_prefix'"
    echo "Value of vcf_file: '$vcf_file'"
    echo "Value of vcf_file_prefix: '$vcf_file_prefix'"
    ...
    dx download "$json_file" -o json_file
    ...
    output_vcf="${json_file_prefix}.refseq_nirvana_203.annotated.vcf"

    ls /usr/bin/

    python nirvana2vcf.py -j $json_file -v $vcf_file -o $output_vcf
